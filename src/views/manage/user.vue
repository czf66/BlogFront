<template>
  <div>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%"
      ...
      <el-form :model="entity" ref="formRef">
        <el-form-item label="用户名" label-width="120px" v-if="!entity.id" prop="username">
        ...
        <el-form-item label="年龄" label-width="120px" prop="age">
          <el-input oninput="value=value.replace(/[^\d.]/g,'')"  @blur="inputChange" v-model="entity.age" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    // 直接令年龄不能输入字母
    inputChange(e){
        this.entity.age = e.target.value
    },
    changeRole(row) {
